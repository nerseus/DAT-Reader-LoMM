...
{
    private static DTXHeader ReadDTXHeader(BinaryReader reader)
    {
        DTXHeader header = new DTXHeader();
    ...
    public static DTXModel LoadDTXModel(string fileNameAndPath, string relativePathToDTX)
    {
